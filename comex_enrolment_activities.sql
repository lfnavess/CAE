...
SELECT
    ...
    CASE
        ...
        WHEN "vt_ca_access_control"."scoreweight" IS NULL OR "vt_ca_access_control"."scoreweight" <> 0	THEN 2
    END 																							AS"score_type",
    CASE
        WHEN
        ...
        THEN
			CAST(
				...
				/ CAST("vt_enrolment_activities"."cmi_score_max" - "vt_enrolment_activities"."cmi_score_min" AS DECIMAL(7,4))
				*100
				AS INT
			)
    END 																							AS"score",
...
FROM
    ...
    LEFT JOIN"vt_ca_access_control"     ON"vt_ca_access_control"."groupid" = "vt_course_groups"."id"AND"vt_ca_access_control"."activityid"="vt_course_activities"."id"
    ...
    LEFT JOIN"vt_enrolment_activities"	ON"vt_enrolment_activities"."enrolmentid"="vt_enrolments"."id"AND"vt_enrolment_activities"."activityid"="vt_course_activities"."id";